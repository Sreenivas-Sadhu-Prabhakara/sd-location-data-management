package com.bank.bian.locationdatamanagement.model;
...
/**
 * The BIAN control record for this service domain: "Location Reference Data Maintenance Agreement".
 *
 * In BIAN, every Service Domain manages exactly one control record type whose
 * shape follows the domain's functional pattern (Maintain) applied
 * to its asset type (Location Reference Data). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Location Reference Data Maintenance Agreement";
