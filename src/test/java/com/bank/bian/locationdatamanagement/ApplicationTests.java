...
class ApplicationTests {
    ...
    void serviceDomainMetadataIsServed() {
        ...
        assertThat(meta).containsEntry("serviceDomain", "Location Data Management");
        assertThat(meta).containsEntry("functionalPattern", "Maintain");
    }

    @Test
    void controlRecordLifecycleWorks() {
        var created = rest.postForEntity(
                "http://localhost:" + port + "/v1/location-reference-data-maintenance-agreement/initiate",
